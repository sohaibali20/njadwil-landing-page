        ...
        <Grid item order={{ xs: 1, md: 2 }} size={{ xs: 12, md: 6 }}>
          ...
          >
            ...
            >
              ...
              >
                نحن شركة رائدة في مجال بيع التذاكر الذكية للفعاليات، حيث نجمع
                بين التكنولوجيا الحديثة والشغف بخلق تجارب استثنائية للمتفرجين
                والمشاركين في الفعاليات. نهدف إلى تسهيل عملية شراء التذاكر
                وتحسين جودة الحضور إلى الفعاليات بأسلوب أكثر ذكاءً
              </Typography>
              <Typography
                className="ibm-plex-sans-arabic"
                variant="body1"
              ...
              >
                ...
                تناسب جميع الاهتمامات والأذواق. سواء كنت تبحث عن تذكرة لحفل
                موسيقي رائع، مباراة رياضية ملحمية، عرض فني مذهل، أو حتى ورشة عمل
                تعليمية، فإننا هنا لنجعل العثور على التذاكر وحجزها مهمة سهلة
                وممتعة
              </Typography>
            </Box>
          </motion.div>
